...
public class NU_cristal3 : NewUPGRADE
{
    public override int level { get => main.SR.N_cristal3; set => main.SR.N_cristal3 = value; }
    public override int S_level { get => main.SR.NS_cristal3; set => main.SR.NS_cristal3 = value; }
