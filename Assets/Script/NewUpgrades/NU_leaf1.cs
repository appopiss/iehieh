...
public class NU_leaf1: NewUPGRADE
{
    //public override int level { get => main.SR.N_leaf1; set => main.SR.N_leaf1 = value; }
    //public override int S_level { get => main.SR.NS_leaf1; set => main.SR.NS_leaf1 = value; }
    ...
    //        thisText.text = tDigit(SliderFactor(),1) + " Leaf / " + (1.0f / calculateCurrentValue()).ToString("F1") + " s";
    //    else
    //        thisText.text = "";
    //}
    ...
    //{
    //    main.SR.leaf += SliderFactor(); ;
    //}

    //public override double SliderFactor()
    //{
    //    return (1.0 + main.Nleafs[1].SliderFactor())*main.idleBackGround.LeafCombo();
    //}
}
