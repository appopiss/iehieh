...
public class Z_DNONE: DUNGEON
{
    //// Use this for initialization
    //void Awake () {
    //    AwakeDungeon(Main.Dungeon.Z_slimeD, "The Slime Spawn Pools", 999999, 32, 300, false,"1");
    //}
    ...
    //    dungeonLevelFactor = Math.Min(Math.Max(main.ally.Level() - 50, 0),29);
    //    isDungeon = true;
    //}
