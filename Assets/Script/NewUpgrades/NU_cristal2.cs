...
public class NU_cristal2 : NewUPGRADE
{
    public override int level { get => main.SR.N_cristal2; set => main.SR.N_cristal2 = value; }
    public override int S_level { get => main.SR.NS_cristal2; set => main.SR.NS_cristal2 = value; }
   ...
   // }
    ...
    {
        return factor + main.Ncristals[2].SliderFactor();
    }
}
