...
public class C_cristal3 : M_UPGRADE
{
    public override int level { get => main.SR.LC_cristal3; set => main.SR.LC_cristal3 = value; }
    ...
    void Update()
    {
        ...
        if (!window.activeSelf)
            return;
        upgradeIcon.sprite = main.UpCrystalSpriteAry[2];
        currentValue = tDigit(calculateCurrentValue(), 1) + "%";
        nextValue = tDigit(calculateNextValue(), 1) + "%";
        L_Upgrades.C_crystal3(ref Name, ref effectExplain, ref explain);
    }
}
