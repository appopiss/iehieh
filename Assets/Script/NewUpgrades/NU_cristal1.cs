...
public class NU_cristal1 : NewUPGRADE
{
    //public override int level { get => main.SR.N_cristal1; set => main.SR.N_cristal1 = value; }
    //public override int S_level { get => main.SR.NS_cristal1; set => main.SR.NS_cristal1 = value; }
    ...
    //        thisText.text = tDigit(SliderFactor(),1) + " Cristal / " + (1.0f / calculateCurrentValue()).ToString("F1") + " s";
    //    else
    //        thisText.text = "";
    //}
    ...
    //{
    //    main.SR.cristal += SliderFactor();
    //}

    //public override double SliderFactor()
    //{
    //    return (1.0 + main.Ncristals[1].SliderFactor()) *main.idleBackGround.CristalCombo();
    //}
}
