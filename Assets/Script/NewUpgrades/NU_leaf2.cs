...
public class NU_leaf2 : NewUPGRADE
{
    public override int level { get => main.SR.N_leaf2; set => main.SR.N_leaf2 = value; }
    public override int S_level { get => main.SR.NS_leaf2; set => main.SR.NS_leaf2 = value; }
   ...
   // }
    ...
    {
        return factor + main.Nleafs[2].SliderFactor();
    }
}
