...
public class Curse_ROW2 : CURSE_RAIN
{
    ...
    {
        return "Road of Warrior 2";
    }
    public override string RestrictionText()
    {
        return "You may only use the Warrior class and your total MP will be capped at 0.";
    }
    public override string RewardText()
    {
        return "Each Clear - Proof Of Warrior * 1, and You will get 10 % additional skill range for Warrior";
    }
    public override CurseId id => CurseId.curse_of_warrior2;
    public override void GetReward()
    {
        StartCoroutine(main.InstantiateLogText("You Cleared Road of Warrior 2!", main.A_ctrl.platina));
        main.ArtiCtrl.CurrentMaterial[ArtiCtrl.MaterialList.ProofOfWarrior] += 1;
    }
