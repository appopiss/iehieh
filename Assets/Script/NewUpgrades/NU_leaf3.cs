...
public class NU_leaf3 : NewUPGRADE
{
    public override int level { get => main.SR.N_leaf3; set => main.SR.N_leaf3 = value; }
    public override int S_level { get => main.SR.NS_leaf3; set => main.SR.NS_leaf3 = value; }
