...
public class Curse_ROWiz2 : CURSE_RAIN
{
    ...
    {
        return "Road of Wizard 2";
    }
    public override string RestrictionText()
    {
        return "You may only use the Wizard class and your total MP will be capped at 0.";
    }
    public override string RewardText()
    {
        return "Each Clear - Proof Of Wizard * 1, and You will get 10 % additional skill range for Wizard";
    }
    public override CurseId id => CurseId.curse_of_wizard2;
    public override void GetReward()
    {
        StartCoroutine(main.InstantiateLogText("You Cleared Road of Wizard 2!", main.A_ctrl.platina));
        main.ArtiCtrl.CurrentMaterial[ArtiCtrl.MaterialList.ProofOfWizard] += 1;
    }
